...
import cn.cqray.android.app2.GetNavDelegate
...
//                UtilsActivityLifecycleImpl.setAnimatorsEnabled()
                ...
                if (activity is GetNavProvider) {
                    GetNavDelegate.get((activity as GetNavProvider)).onCreated()
            ...
            override fun onActivityPostCreated(activity: Activity, savedInstanceState: Bundle?) {
                // 监管GetNavProvider
                if (activity is GetNavProvider) {
                    GetNavDelegate.get((activity as GetNavProvider)).onViewCreated()
                }
                // 打印日志
            ...
            override fun onActivityDestroyed(activity: Activity) {
                ...
                handler.post {
                    ...
                    if (activity is GetNavProvider) {
                        ...
                        GetNavDelegate.get((activity as GetNavProvider)).onDestroyed()
                    }
...
//    }
    ...
    internal fun onForeground(activity: Activity) {
        GetLog.d(this, "程序进入前台")
        appLifecycleCallbacks.forEach { it.onForeground(activity) }
    }

    internal fun onBackground(activity: Activity) {
        GetLog.d(this, "程序退到后台")
